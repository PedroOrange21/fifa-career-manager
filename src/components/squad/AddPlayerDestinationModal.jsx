...
// flujo — Primer Equipo continúa a AddPlayerChoiceModal (Manual/Escanear con IA); Academia
// va directa al asistente manual con el tipo ya fijado a 'Cantera' (mismo criterio que el
// propio botón "Fichar Jugador" de AcademyTab, que tampoco ofrece escaneo por IA).
