...
// Toast flotante y sutil (glassmorphism: fondo oscuro translúcido + blur) en la parte inferior
// de la pantalla, justo por encima del menú flotante (BottomNav, fixed bottom-6 con hasta 64px
// de alto), con temporizador visual (ver @keyframes undo-countdown en index.css),
